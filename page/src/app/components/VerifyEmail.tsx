    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-md w-full mx-4">
                <div className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl rounded-3xl border border-white/60 dark:border-slate-700/60 shadow-2xl shadow-blue-900/10 p-10 text-center transition-colors">
                    ...
                    {status === 'loading' && (
                        <div className="space-y-6">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Verificando tu cuenta...</h2>
                            <p className="text-slate-500 dark:text-slate-400">Estamos activando tu acceso a RetiScan. Esto solo toma unos segundos.</p>
                        </div>
                    )}
                    ...
                    {status === 'success' && (
                        <div className="space-y-6">
                            <div className="flex justify-center">
                                <div className="w-20 h-20 bg-green-50 dark:bg-green-900/20 rounded-full flex items-center justify-center border border-green-200 dark:border-green-800">
                                    <CheckCircle2 className="w-10 h-10 text-green-500" />
                                </div>
                            </div>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">¡Cuenta Verificada!</h2>
                    ...
                    {status === 'error' && (
                        <div className="space-y-6">
                            <div className="flex justify-center">
                                <div className="w-20 h-20 bg-red-50 dark:bg-red-900/20 rounded-full flex items-center justify-center border border-red-200 dark:border-red-800">
                                    <AlertCircle className="w-10 h-10 text-red-500" />
                                </div>
                            </div>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Verificación Fallida</h2>
                            <p className="text-slate-600 dark:text-slate-300">{message}</p>
                            <div className="pt-4">
                                <button
                                    onClick={onBack}
                                    className="w-full py-3 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 rounded-xl font-bold text-base transition-all"
                                >
                                    Volver al inicio
                                </button>
                            </div>
